...
"""
Use regular expressions to obtain serial number, vendor, model, os_version, and
uptime from show version output.
"""
...
def main():
    """
    Use regular expressions to obtain serial number, vendor, model, os_version, and uptime
    from the show version output.
    """
    ...
    my_device['model'] = find model(show_ver)
